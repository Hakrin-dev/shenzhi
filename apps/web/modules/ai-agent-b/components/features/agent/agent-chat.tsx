...
import { CitationProvider } from "@b/lib/citations";
import { MarkdownContent } from "@b/lib/markdown-content";
import { useAskSession, type AskStreamCallbacks } from "@b/lib/chat-stream";
import { useComposerStore } from "@b/stores/composer";
import { mapToAMode, mapToBStyle } from "@b/lib/api/search";
import {
...
import {
  ...
  toAAttachment,
  toBAttachment,
} from "@b/lib/ask/draft";
import { normalizeAIError } from "@b/lib/ask/errors";
import type {
  ChatMessage,
  ChatStyle,
  ChatUIMessage,
