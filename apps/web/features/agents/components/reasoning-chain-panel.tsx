...
export function ReasoningChainPanel({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-primary/20 bg-primary-soft/40">
      ...
      {open && (
        <div className="border-t border-primary/10 bg-white/50 p-3">
          <div className="max-h-[380px] overflow-auto whitespace-pre-wrap break-words rounded-lg bg-white/80 p-3 text-[12.5px] leading-6 text-ink-2 shadow-inner ring-1 ring-line/60">
            {content}
            {streaming && (
