...
const SUBMIT_SUB_NAV: SubNavItem[] = [
...
const AGENT_SUB_NAV: SubNavItem[] = [
  { href: "/agents", label: "AI 对话", matchPrefix: "/agents/ask" },
  { href: "/agents/deep-research", label: "Deep Research" },
  { href: "/agents/auto-research", label: "Auto Research" },
  { href: "/agents/deep-search", label: "Deep Search" },
];

/** 「科研项目」的子栏目即用户创建的项目列表(副标题 = 项目名称) */
const PROJECT_SUB_NAV: SubNavItem[] = projects.map((p) => ({
  href: `/projects/${p.id}`,
  label: p.name,
}));
